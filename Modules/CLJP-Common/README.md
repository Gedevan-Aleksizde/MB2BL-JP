...
また, Nexusでしか配布していないオプションがいくつかあります. 興味のある人はNexusも確認してください.

<!--
## v1.2.x での変化の総評

本体がv1.2にアップデートされたことで, 1000件程度のテキストが新しく追加・変更されました. 変更の大半は, 会話文にNPCの表情を指定するものを追加したもので, 訳文そのものにはほとんど変化がありません. 顕著な改善された点は, アイテムを届ける種のクエスト等で表示される数量の表現が, (馬も羊も牛も匹で数えるとか)まだ少し単位がおかしな箇所がありますが, だいぶましになった点です. そして, 以前からある不自然な訳文はほとんど据え置きでした. さらに, これまで正常に表示されていた一部のアイテム名が英語表示にになってしまったりもしています. 結論として, 予想を裏切るものでありませんでした.

MB2のローカライズは安定版になって以降の2度の大掛かりなアップデートを経ても根本的な問題が解決されていないため, もうしばらくこのmodが必要になると考えています. v1.2に対応した更新では, ここで挙げた問題点はこのmodでは全て修正しています. また, v.1.1向けの最終更新とした 1.1.4以降も, かなりの数の会話の誤訳・わかりにくい表現を発見し修正したので, さらに印象が変わっていると思います.

v1.2で大きく変わったテキストの例, ~~私としてはバグ修正のつもりで作っているので, チートと言われるのは心外ですね~~
...
(初めてNexus Modsを利用する人へ) NexusMods でダウンロードするには, NexusModsのアカウント登録が必要です. どうしてもアカウント登録したくない場合, GitHubやワークショップからダウンロードしてください. 基本的にはどちらにも同じものを同時にアップロードするつもりですが, 全部手動作業なので忘れることもあるかもしれません.
