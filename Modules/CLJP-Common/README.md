...
-   フォントの種類を複数用意しています
-   JISキーボード対応パッチ
    -   MB2 Bannerlord v1.2.8 現在, Bannerlordは日本語配列キーボードを想定していないため, 一部の操作がうまくできません. 手動で直すこともできますが, ファイル上書きしたほうが早いかもしれません.
...
v1.2.8 現在, マウントアンドブレード2には全体で**2万件**程度の日本語テキストが存在します. そのうち **55%**程度を変更しています. あまりにも変更が必要な箇所が多いので, 以下の説明も長くなります. 誤訳のひどさのレベル順に, 以下の6段階に分けてみました. ひどいものから順に紹介します.
...
2.  固有名詞や用語が統一されていない箇所があります.
    -   「ゴールデン・ボア/イノシシの集団」,「西帝国/西部帝国/帝国西部」, 「鎧/装甲/防御/ボディーアーマー」
...
2.  本体側に原因がある不具合が多く存在します.
    ...
    3.  その他本体側のミスと思われるもの
        ...
        -   クエストログの一部がたまに台本みたいな書き方になっているものは, 原文の時点でそうなっています.
        -   金額を表示する際は原則として金貨のアイコンを表示するようにしていますが, ゲーム本体のUI設計の不備によりアイコンを表示できない箇所がいくつかあります.
            -   修正できないこともないですが, MB2のゲーム本体の設計上の問題により, 他のmodと競合する可能性が高いので諦めています.
